...
{   
    ...
    {   
        ...
        if (is_file($view_file)) {   
            // Nếu tồn tại file đó thì tạo ra các biến chứa giá trị truyền vào lúc gọi hàm. Các khóa mảng làm tên biến và giá trị là giá trị biến.   
            //$data là một mảng kết hợp (mảng có khóa và giá trị). Khi sử dụnghàm extract sẽ tạo ra các biến mới từ khóa của mảng và giá trị của mảng.   
            extract($data);               
            //Sau đó lưu giá trị trả về khi chạy file view template với các dữ liệu đó vào 1 biến mà chưa hiển thị luôn ra trình duyệt.   
